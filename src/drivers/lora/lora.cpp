    ...
    case 3:
        {
            ...
            AppDataBuffer[0] = 0xaa;
            AppDataBuffer[1] = 0x55;
            AppDataBuffer[2] = 0xaa;
            AppDataBuffer[3] = 0x55;
        }
        break;
    default:
        break;
...
extern "C" void RadioIrqProcess( void );
    ...
    while (1) {
        ...
        switch( DeviceState )
        {
            case DEVICE_STATE_RESTORE:
            {
                ...
                if( false ) // NvmCtxMgmtRestore( ) == NVMCTXMGMT_STATUS_SUCCESS )
                {
                    printf( "\r\n###### ===== CTXS RESTORED ==== ######\r\n\r\n" );
                }
                else
            ...
            {
                if( false ) // NvmCtxMgmtStore( ) == NVMCTXMGMT_STATUS_SUCCESS )
                {
                    printf( "\r\n###### ===== CTXS STORED ==== ######\r\n" );
                }
 ...
 * Driver 'main' command.
 */
extern "C" __EXPORT int lora_main(int argc, char *argv[]);
